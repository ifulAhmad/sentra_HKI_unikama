    ...
    <div>
        <form action="" method="get">
            <div class="flex flex-col lg:flex-row gap-3">
                <div class="flex-1">
                    <div class="flex flex-col mb-4">
                        ...
                        <input type="text" id="name" class="border-b-2 focus:border-amber-600 py-2 px-3 outline-0"
                            placeholder="Nama..." value="Saiful Islam">
                    </div>
                    <div class="flex flex-col mb-4">
                        <label for="birth" class="font-semibold text-sm ms-3 mb-5">Tanggal Lahir</label>
                        <input type="text" id="birth" class="border-b-2 py-2 px-3 focus:border-amber-600 outline-0"
                ...
                <div class="flex-1">
                    <div class="flex flex-col mb-4">
                        ...
                        <input type="email" id="email" class="border-b-2 py-2 px-3 focus:border-amber-600 outline-0"
                    ...
                    <div class="flex flex-col mb-4">
                        ...
                        <input type="text" id="contact" class="border-b-2 py-2 px-3 focus:border-amber-600 outline-0"
            ...
            <div class="flex flex-col mb-4">
                ...
                <input type="text" id="full_address" class="border-b-2 py-2 px-3 focus:border-amber-600 outline-0" placeholder="full_address"
            ...
            <div class="flex flex-col mb-4">
                ...
                <input type="text" id="nationality" class="border-b-2 py-2 px-3 focus:border-amber-600 outline-0" placeholder="nationality"
                    value="Indonesia">
            </div>

            <div class="text-end">
                <button
                    class="py-2 px-4 rounded-lg border-2 border-blue-600 duration-100 hover:bg-blue-600 hover:text-white">Submit</button>
            </div>
        </form>
    </div>
</div>
