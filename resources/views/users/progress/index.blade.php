...
<div class="p-4 bg-indigo-100 min-h-96">
    ...
    <div class="flex flex-col md:items-center md:flex-row text-sm justify-between gap-4 mb-4">
            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <form action="">
                    <select name="" id="" class="bg-white rounded-md p-2 outline-0 shadow">
                        ...
                        <option value="{{ $copyrightType->slug }}">
                            &bullet; {{ $copyrightType->type }}
                        </option>
                        @endforeach
                    </select>
                </form>
        ...
        <table class="table-auto w-full">
            <thead>
                <tr>
                    ...
                    <th class="text-start p-2">Email Penc.1</th>
