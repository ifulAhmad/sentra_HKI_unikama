    ...
    <form method="POST" action="{{ route('progress.applicantStore', $submission->uuid) }}" class="flex flex-col gap-4">
        ...
        <div>
            ...
            <input type="text" id="nik" name="nik" value="{{ old('nik', $applicant->nik ?? '') }}"
                ...
                @if ($applicant->nik != null) readonly @endif>
            @error('nik')
        ...
        <div>
            ...
            <input type="text" id="nama" name="nama" value="{{ old('nama', $applicant->nama ?? '') }}"
                ...
                @if ($applicant->nama != null) readonly @endif>
            @error('nama')
            <p class="text-red-500 ms-2">{{ $message }}</p>
            @enderror
        </div>
        <div>
            ...
            <input type="email" id="email" name="email" value="{{ old('email', $applicant->email ?? '') }}"
                ...
                @if ($applicant->email != null) readonly @endif>
            @error('email')
            <p class="text-red-500 ms-2">{{ $message }}</p>
            @enderror
        </div>
        <div>
            ...
            <input type="date" id="tgl_lahir" name="tgl_lahir"
                ...
                @if ($applicant->tgl_lahir != null) readonly @endif>
            @error('tgl_lahir')
            <p class="text-red-500 ms-2">{{ $message }}</p>
            @enderror
        </div>
        <div>
            ...
            <input type="text" id="kontak" name="kontak" value="{{ old('kontak', $applicant->kontak ?? '') }}"
                ...
                @if ($applicant->kontak != null) readonly @endif>
            @error('kontak')
            <p class="text-red-500 ms-2">{{ $message }}</p>
            @enderror
        </div>
        <div>
            ...
            <input type="text" id="kewarganegaraan" name="kewarganegaraan"
                ...
                @if ($applicant->kewarganegaraan != null) readonly @endif>
        ...
        <div>
            ...
            <textarea id="alamat" name="alamat" rows="3"
                ...
                @if ($applicant->alamat != null) readonly @endif>{{ old('alamat', $applicant->alamat ?? '') }}</textarea>
            @error('alamat')
            <p class="text-red-500 ms-2">{{ $message }}</p>
            @enderror
        </div>
        <div>
            ...
            <input type="text" id="kode_pos" name="kode_pos"
                ...
                @if ($applicant->kode_pos != null) readonly @endif>
            @error('kode_pos')
            <p class="text-red-500 ms-2">{{ $message }}</p>
            @enderror
        </div>
