    ...
    <div>
        ...
        <div class="text-sm flex font-light flex-col">
            <div class="rounded-md flex items-center gap-3 px-3 mb-2">
                ...
                <h4 class="w-16 font-semibold uppercase">Aksi</h4>
            </div>
            <div>
                <div class="rounded-md bg-white flex gap-3 p-3 mb-1">
                    <p class="w-16">1</p>
                ...
                <div class="rounded-md bg-white flex gap-3 p-3 mb-1">
                    <p class="w-16">2</p>
                    <p class="flex-1">Lorem ipsum, dolor sit amet consectetur adipisicing elit... Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Omnis, delectus?</p>
                    <p class="flex-1">20 November 2024</p>
                    <p class="flex-1">saifultesting@gmaail.com</p>
                    <div class="w-16">
                        <div class="relative">
