...
<div class="flex justify-center items-center ">
    <div class="w-[70%]" id="form">
        <h3 class="my-4 font-semibold">Edit Template Surat</h3>
        <form action="{{ route('admin.letter.update', $letter->id) }}" method="post" class="text-sm"
            ...
            <div class="text-end">
                <button type="submit"
                    class="px-4 py-2 text-sm rounded-md bg-indigo-600 duration-200 text-white hover:bg-indigo-700">Update</button>
            </div>
        </form>
    </div>
</div>
